...
public class PageHierarchyServiceTest {
    @Autowired
    ...
    public void list(){
        ...
        PageHierarchies pageHierarchies = pageHierarchyService.list(menu.getMenuId());
        List<PageHierarchyResponseDto> pageHierarchyResponseDtos = pageHierarchies.responseList();
        Assert.assertTrue(pageHierarchyResponseDtos.size() == 1);
    }
    ...
    public void getCurrentPath(){
        ...
        pageService.saveBranch(page3,page2.getPageId());

        PageHierarchies pageHierarchies = pageHierarchyService.getCurrentPath(page3.getPageId());
        List<PageHierarchyResponseDto> pageHierarchyResponseDtos = pageHierarchies.responseList();
        Assert.assertTrue(pageHierarchyResponseDtos.size() == 3);
    }
}
