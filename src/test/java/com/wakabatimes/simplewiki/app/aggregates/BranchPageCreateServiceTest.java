...
public class BranchPageCreateServiceTest {
    @Autowired
    ...
    public void save(){
        ...
        Assert.assertNotNull(pageService.get(page2.getPageId()));
        Assert.assertNotNull(bodyService.getCurrent(page2.getPageId()));
    }
