...
public class MainMenuShowServiceTest {
    @Autowired
    ...
    public void list(){
        ...
        List<MainMenuResponseDto> mainMenuResponseDtoList = mainMenuShowService.list();
    ...
    public void listByMenuLimit(){
        ...
        List<MainMenuResponseDto> mainMenuResponseDtoList = mainMenuShowService.listByMenuLimit(MenuLimit.PUBLIC);
        Assert.assertTrue(mainMenuResponseDtoList.size() == 1);
    }
}
