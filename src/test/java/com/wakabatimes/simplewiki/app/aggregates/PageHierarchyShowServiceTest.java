...
public class PageHierarchyShowServiceTest {
    @Autowired
    ...
    public void list(){
        ...
        List<PageHierarchyResponseDto> pageHierarchyResponseDtos = pageHierarchyShowService.list(menu.getMenuId());
    ...
    public void getCurrentPath(){
        ...
        List<PageHierarchyResponseDto> pageHierarchyResponseDtos = pageHierarchyShowService.getCurrentPath(page3.getPageId());
